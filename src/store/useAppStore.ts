  ...
  persist(
    (set) => ({
      ...
      defaultModelAppearance:
        'Asian female, professional attire, natural lighting, high quality photography',
      defaultDesignStyle:
      ...
      visualProfiles: [
        {
          ...
          modelAppearance:
            'Asian professional, formal attire, natural office lighting, high-end commercial photography',
          designStyle:
            'Professional corporate blue & white palette, clean lines, high resolution infographic style',
        },
        {
          id: 'default-minimal-hk',
          name: 'Minimalist HK',
          modelAppearance:
            'Hong Kong lifestyle, trendy causal wear, bright airy natural light, urban chic',
      ...
      updateProfile: (updatedProfile) =>
        set((state) => ({
          ...
          activeProfile:
            state.activeProfile?.id === updatedProfile.id ? updatedProfile : state.activeProfile,
        })),
      deleteProfile: (id) =>
        set((state) => ({
      ...
      addVisualProfile: (profile) =>
        set((state) => ({
          visualProfiles: [...state.visualProfiles, profile],
        })),
      updateVisualProfile: (updated) =>
        set((state) => ({
