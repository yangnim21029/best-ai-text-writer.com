...
export const HeadingOptimizerModal: React.FC<HeadingOptimizerModalProps> = ({
  ...
  const { targetAudience, articleTitle, headingOptimizations, setHeadingOptimizations } =
    useAnalysisStore();
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">
                AI-powered refinement for high-impact H2s
              </p>
            </div>
          </div>
          <button
          ...
          {headingOptimizations.length === 0 && !isAnalyzing ? (
            <div className="flex flex-col items-center justify-center h-64 text-center">
              ...
              <p className="text-gray-500 max-w-sm mb-6">
                We will analyze your article's structure and suggest 5 variations for each H2
                heading (Professional, Emotional, Viral, etc.).
              </p>
              <button
            ...
            <div className="flex flex-col items-center justify-center h-64">
              ...
              <p className="text-sm text-gray-400 mt-1">
                Generating high-converting headline variations
              </p>
            </div>
          ) : (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="font-medium text-gray-800 dark:text-gray-200 flex items-center gap-2">
                          ...
                          {isSelectedChanged && (
                            <span className="px-1.5 py-0.5 bg-green-100 text-green-700 text-[10px] rounded border border-green-200 font-bold">
                              UPDATED
                            </span>
                          )}
                        </div>
                      ...
                      <div className="border-t border-gray-100 dark:border-gray-700 p-4 bg-gray-50/50 dark:bg-gray-800/50">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                          ...
                          <label
                            ...
                            onClick={() =>
                              setSelectedOptions((prev) => ({ ...prev, [idx]: opt.h2_before }))
                            }
                          >
                            <div
                          ...
                          {opt.h2_options?.map((option, optIdx) => (
                            <label
                              ...
                              onClick={() =>
                                setSelectedOptions((prev) => ({ ...prev, [idx]: option.text }))
                              }
                            >
                              <div
                              ...
                              >
                                {selectedOptions[idx] === option.text && (
                                  <div className="w-1.5 h-1.5 rounded-full bg-white" />
                                )}
                              </div>
                              <div className="flex-1">
                                <div className="flex items-center justify-between">
                                  ...
                                  {option.score && (
                                    <span className="text-[10px] font-bold text-blue-600 bg-blue-100 px-1.5 py-0.5 rounded px-1">
                                      Score: {option.score}
                                    </span>
                                  )}
                                </div>
