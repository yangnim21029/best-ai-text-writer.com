...
export const WebsiteProfileSection: React.FC<WebsiteProfileSectionProps> = ({
  ...
  return (
    <div
      className={`bg-white rounded-xl border border-gray-100 shadow-[0_2px_8px_rgba(0,0,0,0.02)] overflow-hidden transition-all duration-300 ${showDetails ? 'ring-2 ring-blue-50/50' : 'hover:shadow-md'}`}
    >
      <div
      ...
      >
        ...
        <div className="flex items-center gap-1">
          ...
          <ChevronDown
            className={`w-4 h-4 text-slate-300 transition-transform duration-300 ${showDetails ? 'rotate-180' : ''}`}
          />
        </div>
      </div>
