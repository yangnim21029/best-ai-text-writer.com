...
export const SourceMaterialSection: React.FC<SourceMaterialSectionProps> = ({
    ...
    const PageCardContent = () => (
        <div className="flex items-center gap-3 w-full">
            ...
            <ChevronDown className={`w-3.5 h-3.5 text-slate-400 flex-shrink-0 transition-transform duration-300 ${isSourceInputOpen ? 'rotate-180' : ''}`} />
        </div>
    );
                                    ...
                                    <div className="flex items-center justify-between mt-3 gap-2">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <button
                                                ...
                                                onClick={(e) => {
                                                    e.stopPropagation();
                                                    const name = prompt('Save as new profile:', (activePageTitle || '') + ' (Copy)');
