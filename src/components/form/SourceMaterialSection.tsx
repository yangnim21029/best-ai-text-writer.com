...
export const SourceMaterialSection: React.FC<SourceMaterialSectionProps> = ({
  ...
  const visibleImages = showAllExtracted
    ? orderedImages
    : orderedImages.slice(0, MAX_PREVIEW_IMAGES);
  ...
  const DefaultHeader = () => (
    <div className="flex justify-between items-center gap-3 w-full">
      ...
      <div className="flex items-center gap-2.5 flex-shrink-0 ml-auto">
        {isSourceInputOpen && (
          <div
            className="flex bg-white p-0.5 rounded-lg border border-gray-200 shadow-sm transition-all"
              ...
              {inputType === 'text' ? (
                <div className="relative group">
                  <div className="mb-3">
                    ...
                    />
                    {errors.title && (
                      <p className="text-[10px] text-red-500 mt-1 ml-1">{errors.title.message}</p>
                    )}
                  </div>
                  <textarea
                  ...
                  {errors.referenceContent && (
                    <p className="text-[10px] text-red-500 mt-1">
                      {errors.referenceContent.message}
                    </p>
                  )}
