                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-8 custom-scrollbar bg-[#fbfbfb]">
                    ...
                    <section className="space-y-4">
                        ...
                        <div className="space-y-4 bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
                            <div className="space-y-1.5">
                                <label className="text-[11px] font-bold text-gray-500 uppercase tracking-tight">分析與寫作模型 (Text Model)</label>
                                <input
                                    type="text"
                                    value={modelFlash}
                            ...
                            <div className="space-y-1.5">
                                <label className="text-[11px] font-bold text-gray-500 uppercase tracking-tight">視覺與圖像模型 (Vision Model)</label>
                                <input
                                    type="text"
                                    value={modelImage}
                    ...
                    <section className="space-y-4">
                        ...
                        <div className="space-y-5 bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
                            <div className="space-y-1.5">
                                <label className="text-[11px] font-bold text-gray-500 uppercase tracking-tight">人物外觀 (預設值)</label>
                                <textarea
                            ...
                            <div className="space-y-1.5">
                                <label className="text-[11px] font-bold text-gray-500 uppercase tracking-tight">圖表/資訊圖風格 (預設值)</label>
                                <textarea
                    ...
                    <section className="space-y-4">
                        ...
                        <div className="space-y-3 bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
                            <div className="flex items-center justify-between">
                                ...
                                >
                                    <span className={`inline-block h-3.5 w-3.5 transform rounded-full bg-white transition-transform ${useRag ? 'translate-x-4.5' : 'translate-x-1'}`} />
                                </button>
                            </div>
                            ...
                            <div className="pt-3 border-t border-gray-50 flex items-center justify-between">
                                ...
                                >
                                    <span className={`inline-block h-3.5 w-3.5 transform rounded-full bg-white transition-transform ${autoImagePlan ? 'translate-x-4.5' : 'translate-x-1'}`} />
                                </button>
                            </div>
                        </div>
                    </section>
                        ...
                        <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm space-y-5">
                            <div className="space-y-3">
                                <div className="flex justify-between items-center">
                                    <label className="text-[11px] font-bold text-gray-500 uppercase tracking-tight">字符間隔 (每 X 字提取一個詞)</label>
                                    <span className="text-xs font-mono font-bold text-blue-600 bg-blue-50 px-2 py-0.5 rounded">{keywordCharDivisor}</span>
                                </div>
                                <input
                                    type="range"
                                    min="50"
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-1.5">
                                    <label className="text-[11px] font-bold text-gray-500 uppercase tracking-tight">最小詞數</label>
                                    <input
                                        type="number"
                                        value={minKeywords}
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-[11px] font-bold text-gray-500 uppercase tracking-tight">最大詞數</label>
                                    <input
                                        type="number"
                                        value={maxKeywords}
