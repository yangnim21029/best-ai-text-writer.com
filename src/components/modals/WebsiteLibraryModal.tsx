        ...
        <div className="px-10 py-8 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
          <div>
            ...
            <p className="text-sm text-slate-500 font-medium mt-1">
              Manage site identities, domain analysis, and brand authority.
            </p>
          </div>
          <button
            onClick={onClose}
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="min-w-0 flex-1">
                        ...
                        <p
                          className={`text-[10px] font-medium truncate mt-0.5 ${isActive ? 'text-indigo-100' : 'text-slate-400'}`}
                        >
                    ...
                    <>
                      ...
                      <div className="grid grid-cols-1 gap-8">
                        <div className="space-y-4">
                          <label className="text-[10px] font-black text-indigo-600 uppercase tracking-[0.2em]">
                            Site Identification URL
                          </label>
                          ...
                          <p className="text-[10px] text-slate-400 font-medium italic">
                            Analyzing the site URL will automatically update the Niche and Authority
                            Terms below based on the entire brand profile.
                          </p>
                        </div>
              ...
              <div className="h-full flex flex-col items-center justify-center text-slate-200 text-center space-y-6">
                ...
                <div>
                  ...
                  <p className="text-slate-300 font-medium max-w-sm mx-auto mt-2">
                    Pick a brand from your library or create a new one from a URL to instantly load
                    identity settings.
                  </p>
                </div>
                <button
