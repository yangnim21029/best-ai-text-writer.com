          ...
          <aside className="w-80 border-r border-gray-50 bg-gray-50/30 overflow-y-auto custom-scrollbar p-6 space-y-8">
            ...
            <div>
              ...
              <p className="mt-2 text-[10px] text-gray-400 font-medium">
                Applied to Lifestyle and Product photography.
              </p>
            </div>
            ...
            <div>
              ...
              />
              <p className="mt-2 text-[10px] text-gray-400 font-medium">
                Applied to data visualizations and diagrams.
              </p>
            </div>
              ...
              <div className="h-full flex flex-col items-center justify-center text-center space-y-4 animate-in fade-in duration-500">
                ...
                <div className="max-w-xs">
                  ...
                  <p className="text-sm text-gray-500 mt-2">
                    Click <strong>"Auto-Plan All Visuals"</strong> to let AI analyze your article
                    and suggest the perfect images.
                  </p>
                </div>
              </div>
            ) : (
                        ...
                        <div className="flex-1 space-y-4">
                          <div>
                            ...
                            <textarea
                              ...
                              onChange={(e) =>
                                onUpdatePlan(plan.id, { generatedPrompt: e.target.value })
                              }
