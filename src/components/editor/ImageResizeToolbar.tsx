...
import { AlignLeft, AlignCenter, AlignRight, Maximize, Minimize, Trash2, Layout } from 'lucide-react';
            ...
            <div className="flex items-center gap-0.5 border-r border-gray-100 pr-1 px-1">
                <button
                    ...
                    className={cn(
                        ...
                        currentWidth === '300' || currentWidth === '300px' ? "text-blue-600 bg-blue-50" : "text-gray-500"
                    )}
                >
                    S
                </button>
                <button
                    ...
                    className={cn(
                        "px-2 py-1 text-[10px] font-bold rounded hover:bg-gray-100 transition-colors",
                        currentWidth === '600' || currentWidth === '600px' ? "text-blue-600 bg-blue-50" : "text-gray-500"
                    )}
                >
                    M
                </button>
