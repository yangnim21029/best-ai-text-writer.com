...
export default function AppPage() {
    ...
    useEffect(() => {
        ...
        if (generationStore.status === 'analysis_ready' && hasStructure && !app.showPlanModal && !hasAutoShownPlanModal) {
    ...
    }, [generationStore.status, generationStore.generationStep, analysisStore.refAnalysis?.structure, app.showPlanModal, hasAutoShownPlanModal, app]);
