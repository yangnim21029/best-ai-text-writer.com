...
html
 (60), HTML (18), __html (3)	
html
__html is React dangerouslySetInnerHTML specific (keep). HTML should be 
html
 or htmlContent.
...
Files likely involved: Service adapters, API types.
2. Variable vs Type naming
...
Rule: Variables = camelCase, Types/Components = PascalCase.
3. Acronyms
