...
"[project]/src/services/engine/promptService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const calculateCost = (usage, modelType)=>{
    ...
    const rates = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PRICING"][modelType];
...
"[project]/src/services/engine/genAIClient.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const DEFAULT_RETRY = {
    attempts: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AI_DEFAULTS"].RETRY_ATTEMPTS,
    delayMs: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AI_DEFAULTS"].RETRY_DELAY_MS
};
const DEFAULT_TIMEOUT = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AI_DEFAULTS"].TIMEOUT_MS;
...
const AI_BASE_URL = ("TURBOPACK compile-time truthy", 1) ? '' : "TURBOPACK unreachable";
const AI_PATH = ("TURBOPACK compile-time truthy", 1) ? '/api/ai' : "TURBOPACK unreachable";
...
"[project]/src/services/engine/aiService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$genAIClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/engine/genAIClient.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/config/constants.ts [app-client] (ecmascript)");
...
class AIService {
    getModel(key) {
        const settings = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useAppStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"].getState();
        if (key === 'FLASH') return settings.modelFlash;
        if (key === 'IMAGE_PREVIEW') return settings.modelImage;
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MODEL"][key];
    }
    /**
     ...
     */ async runText(prompt, modelKey = 'FLASH', config) {
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$genAIClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["genAIClient"].request({
                model,
                contents: prompt,
                config
            });
            const { usage, cost } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateCost"])(response.usageMetadata, modelKey);
            return {
                text: response.text,
                usage,
                cost,
...
"[project]/src/services/engine/schemaTypes.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/services/engine/promptTemplates.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/services/research/productFeatureToPainPointMapper.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/engine/promptService.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$aiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/engine/aiService.ts [app-client] (ecmascript)");
...
const generateProductBrief = async (productName, productUrl, targetAudience)=>{
    ...
    const prompt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptTemplates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["promptTemplates"].productBrief({
        productName,
        productUrl,
        languageInstruction
    });
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$aiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aiService"].runJson(prompt, 'FLASH', {
...
const mapProblemsToProduct = async (productBrief, articleTopic, targetAudience)=>{
    const startTs = Date.now();
    const languageInstruction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLanguageInstruction"])(targetAudience);
    const prompt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptTemplates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["promptTemplates"].productMapping({
        productBrief,
        articleTopic,
        languageInstruction
    });
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$aiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aiService"].runJson(prompt, 'FLASH', {
            type: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$schemaTypes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Type"].ARRAY,
            items: {
                type: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$schemaTypes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Type"].OBJECT,
                properties: {
                    painPoint: {
...
const parseProductContext = async (rawText)=>{
    const startTs = Date.now();
    const prompt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptTemplates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["promptTemplates"].productContextFromText({
        rawText
    });
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$aiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aiService"].runJson(prompt, 'FLASH', {
...
const summarizeBrandContent = async (urls, targetAudience)=>{
    const startTs = Date.now();
    const languageInstruction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLanguageInstruction"])(targetAudience);
    const prompt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptTemplates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["promptTemplates"].brandSummary({
        urls,
        languageInstruction
    });
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$aiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aiService"].runText(prompt, 'FLASH');
        return {
            data: response.text,
            usage: response.usage,
            cost: response.cost,
...
"[project]/src/services/research/webScraper.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/services/research/referenceAnalysisService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const extractWebsiteTypeAndTerm = async (content)=>{
    ...
    return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$aiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aiService"].runJson(prompt, 'FLASH', {
        type: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$schemaTypes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Type"].OBJECT,
        properties: {
            websiteType: {
                type: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$schemaTypes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Type"].STRING
...
const analyzeReferenceStructure = async (referenceContent, targetAudience)=>{
    ...
    const structurePrompt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptTemplates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["promptTemplates"].narrativeStructure({
        content: referenceContent,
        targetAudience,
        languageInstruction
    });
    const voicePrompt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptTemplates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["promptTemplates"].voiceStrategy({
        content: referenceContent,
        targetAudience,
        languageInstruction
    });
    try {
        ...
        const [structRes, voiceRes] = await Promise.all([
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$aiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aiService"].runJson(structurePrompt, 'FLASH', {
                type: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$schemaTypes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Type"].OBJECT,
                properties: {
                    h1Title: {
                        type: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$schemaTypes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Type"].STRING
                    ...
                    structure: {
                        ...
                        items: {
                            ...
                            properties: {
                                ...
                                exclude: {
                                    type: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$schemaTypes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Type"].BOOLEAN
                                },
                                excludeReason: {
                                    type: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$schemaTypes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Type"].STRING
                                },
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$aiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aiService"].runJson(voicePrompt, 'FLASH', {
                type: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$schemaTypes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Type"].OBJECT,
                properties: {
                    generalPlan: {
                        type: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$schemaTypes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Type"].ARRAY,
        ...
        const errorUsage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toTokenUsage"])(0); // Simplified error handling
        const errorCost = {
            inputCost: 0,
            outputCost: 0,
            totalCost: 0
...
"[project]/src/services/engine/embeddingService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const embedTexts = async (texts, options = {})=>{
    ...
    const body = {
        texts,
        model: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EMBED_MODEL_ID"]
    };
    ...
    const response = await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$genAIClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildAiUrl"])('/embed'), {
        method: 'POST',
        headers,
...
"[project]/src/services/generation/imageService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const analyzeImageWithAI = async (imageUrl, prompt = 'Describe this image in detail.', model = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MODEL"].FLASH)=>{
    const startTs = Date.now();
    try {
        const response = await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$genAIClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildAiUrl"])('/vision'), {
            method: 'POST',
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$genAIClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAiHeaders"])(),
            body: JSON.stringify({
                prompt,
                image: imageUrl,
                model
        ...
        const metrics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateCost"])(result, modelType);
        return {
            data: result.text,
            ...metrics,
            duration
...
const analyzeVisualStyle = async (scrapedImages, websiteType)=>{
    ...
    const prompt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptTemplates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["promptTemplates"].visualStyle({
        languageInstruction: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLanguageInstruction"])('zh-TW'),
        analyzedSamples,
        websiteType
    });
    try {
...
const generateImagePromptFromContext = async (contextText, targetAudience, visualStyle = "")=>{
    const startTs = Date.now();
    const languageInstruction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLanguageInstruction"])(targetAudience);
    const prompt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptTemplates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["promptTemplates"].imagePromptFromContext({
        contextText,
        languageInstruction,
        visualStyle,
...
const generateImage = async (prompt)=>{
    const startTs = Date.now();
    try {
        const response = await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$genAIClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildAiUrl"])('/image'), {
            method: 'POST',
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$genAIClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAiHeaders"])(),
            body: JSON.stringify({
                prompt,
                model: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MODEL"].IMAGE_PREVIEW,
                aspectRatio: '16:9'
            })
        });
        const contentType = response.headers.get('content-type') || '';
        ...
        const metrics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateCost"])(payload.totalUsage || payload.usageMetadata || payload.usage, 'IMAGE_GEN');
        return {
            data: imageData,
            ...metrics,
            duration: Date.now() - startTs
...
"[project]/src/services/engine/contextFilterService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const filterSectionContext = async (sectionTitle, allKeyPoints, allAuthTerms, brandKnowledgeBase, targetAudience)=>{
    ...
    try {
        ...
        const metrics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateCost"])(response.usage, 'FLASH');
        return {
            data: {
...
"[project]/src/services/generation/contentGenerationService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/engine/promptService.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$contextFilterService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/engine/contextFilterService.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptTemplates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/engine/promptTemplates.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/config/constants.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$aiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/engine/aiService.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$schemaTypes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/engine/schemaTypes.ts [app-client] (ecmascript)");
...
const generateSectionContent = async (config, sectionTitle, specificPlan, generalPlan, keywordPlans, previousSections = [], futureSections = [], authorityAnalysis = null, keyInfoPoints = [], currentCoveredPointsHistory = [], currentInjectedCount = 0, sectionMeta = {})=>{
    ...
    const keywordPlansForPrompt = keywordPlans.slice(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SEMANTIC_KEYWORD_LIMIT"]);
    // RAG: Filter context to reduce token usage
    const contextFilter = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$contextFilterService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["filterSectionContext"])(sectionTitle, keyInfoPoints, authorityAnalysis?.relevantTerms || [], config.brandKnowledge, config.targetAudience);
    ...
    const prompt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptTemplates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["promptTemplates"].sectionContent({
        sectionTitle,
        languageInstruction,
        previousSections,
        futureSections,
    ...
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$aiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aiService"].runJson(prompt, 'FLASH', {
        ...
        properties: {
            ...
            injectedCount: {
                type: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$schemaTypes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Type"].INTEGER,
...
const generateSnippet = async (prompt, targetAudience, config)=>{
    const languageInstruction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLanguageInstruction"])(targetAudience);
    const fullPrompt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptTemplates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["promptTemplates"].snippet({
        prompt,
        languageInstruction
    });
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$aiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aiService"].runText(fullPrompt, 'FLASH', config);
    return {
        data: res.text,
        usage: res.usage,
        cost: res.cost,
...
const rebrandContent = async (currentContent, productBrief, targetAudience)=>{
    const languageInstruction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLanguageInstruction"])(targetAudience);
    const prompt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptTemplates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["promptTemplates"].rebrandContent({
        productBrief,
        languageInstruction,
        currentContent
    });
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$aiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aiService"].runText(prompt, 'FLASH');
    return {
        data: res.text,
        usage: res.usage,
        cost: res.cost,
...
const smartInjectPoint = async (fullHtmlContent, pointToInject, targetAudience)=>{
    ...
    const findPrompt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptTemplates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["promptTemplates"].smartFindBlock({
        pointToInject,
        blocks
    });
    const findRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$aiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aiService"].runText(findPrompt, 'FLASH');
    ...
    const rewritePrompt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptTemplates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["promptTemplates"].smartRewriteBlock({
        pointToInject,
        targetHtml: targetBlock.html,
        languageInstruction
    });
    const rewriteRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$aiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aiService"].runText(rewritePrompt, 'FLASH');
    const totalUsage = {
    ...
    const totalCost = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateCost"])(totalUsage, 'FLASH');
    return {
        data: {
...
"[project]/src/services/generation/headingRefinerService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const calculateBestOption = (h2Before, options, fallback, baseEmbedding, optionEmbeddings)=>{
    ...
    const scored = options.map((opt, idx)=>{
        ...
        const score = baseEmbedding && vec ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$embeddingService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cosineSimilarity"])(baseEmbedding, vec) : undefined;
        return {
            ...opt,
            score
        };
...
const refineHeadings = async (articleTitle, headings, targetAudience)=>{
    ...
    const refineBatch = async (batch)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].log('refining_headings', `Refining ${batch.length} headings...`);
        const prompt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptTemplates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["promptTemplates"].batchRefineHeadings({
            articleTitle,
            headings: batch,
            languageInstruction
        });
        ...
        if (allTextsToEmbed.length > 0) {
            try {
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].log('refining_headings', `Batch embedding ${allTextsToEmbed.length} texts...`);
                allEmbeddings = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$embeddingService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["embedTexts"])(allTextsToEmbed);
            } catch (err) {
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].warn('refining_headings', 'Batch embedding failed', err);
            }
        }
        ...
        return {
            data: results,
            usage: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toTokenUsage"])(response.usage),
...
"[project]/src/services/engine/nlpService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/services/research/termUsagePlanner.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$aiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/engine/aiService.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$schemaTypes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/engine/schemaTypes.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p$2d$limit$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/p-limit/index.js [app-client] (ecmascript)"); // v6+ is pure ESM
;
;
;
;
...
const extractSemanticKeywordsAnalysis = async (referenceContent, keywords, targetAudience)=>{
    ...
    const topKeywords = uniqueKeywords.slice(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SEMANTIC_KEYWORD_LIMIT"]);
    ...
    const allAnalysisPayloads = topKeywords.map((k)=>({
            word: k.token,
            snippets: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["extractRawSnippets"])(referenceContent, k.token, 80).slice(0, 2).map((snippet)=>truncateSnippet(snippet))
        }));
    const languageInstruction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLanguageInstruction"])(targetAudience);
    // BATCHING STRATEGY:
    ...
    const limit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p$2d$limit$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(CONCURRENCY_LIMIT);
    ...
    const batchPromises = batches.map((batchPayload, batchIdx)=>limit(async ()=>{
            ...
            const planPrompt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptTemplates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["promptTemplates"].frequentWordsPlacementAnalysis({
                analysisPayloadString,
                languageInstruction
            });
            try {
                console.log(`[SemanticKeywords] Starting batch ${batchIdx + 1}/${batches.length}...`);
                const planRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$aiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aiService"].runJson(planPrompt, 'FLASH', {
                    type: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$schemaTypes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Type"].ARRAY,
                    items: {
                        type: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$schemaTypes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Type"].OBJECT,
                        properties: {
    ...
    return {
        data: finalPlans,
        usage: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toTokenUsage"])(totalUsage),
        cost: totalCost,
        duration: Date.now() - startTs
    };
};
...
"[project]/src/services/research/authorityService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const analyzeAuthorityTerms = async (authorityTerms, articleTitle, websiteType, targetAudience)=>{
    ...
    const languageInstruction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLanguageInstruction"])(targetAudience);
    const prompt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptTemplates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["promptTemplates"].authorityAnalysis({
    ...
    try {
        ...
        const usage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toTokenUsage"])(e?.usage);
        return {
            data: {
                relevantTerms: [],
                combinations: []
...
"[project]/src/services/research/regionalAnalysisService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const analyzeRegionalTerms = async (content, targetAudience)=>{
    ...
    const startTs = Date.now();
    const prompt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$promptTemplates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["promptTemplates"].regionalBrandAnalysis({
        content,
        targetAudience
    });
...
"[project]/src/services/generation/contentDisplayService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/services/research/regionGroundingService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
- 每個輸入的實體都必須有一個對應的輸出`;
    ...
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$aiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aiService"].runJsonWithSearch(prompt, 'FLASH', schema);
...
只輸出 JSON，不要其他文字。`;
    ...
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$engine$2f$aiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aiService"].runJson(prompt, 'FLASH', schema);
    return {
...
//# sourceMappingURL=src_services_c444eb75._.js.map