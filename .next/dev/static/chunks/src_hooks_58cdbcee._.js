...
const runAnalysisPipeline = async (config)=>{
    ...
    const appStore = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useAppStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"].getState();
...
"[project]/src/hooks/useAppAccess.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(useAppAccess, "nzNUdV6WFvFmJl27lavpDoQ/IbI=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/hooks/useContentScore.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useContentScore() {
    ...
    const { contentScore, setContentScore } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useAppStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"])();
    const structurePoints = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useContentScore.useMemo[structurePoints]": ()=>{
            ...
            legacyGeneral.forEach({
                "useContentScore.useMemo[structurePoints]": (p)=>{
                    if (p) general.add(p);
                }
            }["useContentScore.useMemo[structurePoints]"]);
            legacyBrand.forEach({
            ...
            structure.forEach({
                "useContentScore.useMemo[structurePoints]": (s)=>{
        ...
        "useContentScore.useEffect": ()=>{
            ...
            if (analysisStore.keywordPlans.length > 0) {
                ...
                const usedKeywords = analysisStore.keywordPlans.filter({
                    "useContentScore.useEffect.usedKeywords": (k)=>k.word && contentLower.includes(k.word.toLowerCase())
                }["useContentScore.useEffect.usedKeywords"]);
...
_s(useContentScore, "Cay0h6vDOI5W/M090T+LYcGBD+Q=", false, function() {
    return [
...
"[project]/src/hooks/useAppHydration.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useAppHydration() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useAppHydration.useEffect": ()=>{
            if (restorePromptedRef.current || ("TURBOPACK compile-time value", "object") === 'undefined') return;
            const persistedKeys = [
                'pro_content_writer_analysis',
                'pro_content_writer_generation',
            ...
            const hasPersisted = persistedKeys.some({
                "useAppHydration.useEffect.hasPersisted": (k)=>localStorage.getItem(k)
            }["useAppHydration.useEffect.hasPersisted"]);
            if (!hasPersisted) return;
            restorePromptedRef.current = true;
            const shouldRestore = window.confirm('偵測到上次的資料，是否恢復? 選擇「取消」將清空並重新開始。');
            if (!shouldRestore) {
                persistedKeys.forEach({
                    "useAppHydration.useEffect": (k)=>localStorage.removeItem(k)
                }["useAppHydration.useEffect"]);
                analysisStore.reset();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useAppHydration.useEffect": ()=>{
            if (hydratedAnalysisRef.current || generationStore.status !== 'idle' || generationStore.analysisResults || ("TURBOPACK compile-time value", "object") === 'undefined') return;
...
_s(useAppHydration, "lXVOM6WFOGJ642TVITYdlD4rWNY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useGenerationStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGenerationStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useAnalysisStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAnalysisStore"]
    ];
...
//# sourceMappingURL=src_hooks_58cdbcee._.js.map